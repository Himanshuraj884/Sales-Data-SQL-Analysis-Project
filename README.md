...
A self-contained SQL analytics project using a e-commerce dataset. The project uses **MySQL 8.0** as its target database and contains 10 analytical queries covering filtering, aggregation, joins, subqueries, CTEs, and business-metric analysis.
